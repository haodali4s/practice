<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="(user, index) in address" :key="user.id" @click="changeDefault(user)">
      ...
      <div class="address clearFix">
        <span class="username" :class="{selected:current==index}" v-for="(item,index) in pay" :key="index" @click="changecurrent(index)">{{ item }}</span>
      </div>
      <div class="line"></div>
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        ...
        收货人：
        <span>{{ defaultUser.consignee }}</span>
...
.trade-container {
  .s1.selected {
    border: 1px solid #ee0f0f !important;
  }
  .title {
    width: 1200px;
    margin: 0 auto;
